...
if [ ! -d $PROJECT ]; then
	...
	cordova create ../../byteballbuilds/project-$1 jp.kizunacoin.wallet Kizunacoin
	checkOK
...
#  checkOK
#
#  cp ios/Kizunacoin-Info.plist $PROJECT/platforms/ios/Kizunacoin-Info.plist
#  checkOK
#
#  mkdir -p $PROJECT/platforms/ios/Kizunacoin/Resources/icons
#  checkOK
#
#  mkdir -p $PROJECT/platforms/ios/Kizunacoin/Resources/splash
#  checkOK
#
#  cp -R ios/icons/* $PROJECT/platforms/ios/Kizunacoin/Resources/icons
#  checkOK
#
#  cp -R ios/splash/* $PROJECT/platforms/ios/Kizunacoin/Resources/splash
#  checkOK
fi
