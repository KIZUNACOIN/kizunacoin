  ...
  grunt.initConfig({
    ...
    nwjs: {
      options: {
          ...
          macPlist: {
          	CFBundleURLTypes: [{CFBundleURLName: 'Kizunacoin action', CFBundleURLSchemes: ['byteball']}],
      		/*CFBundleIconFile: 'nw.icns',*/
      		LSHasLocalizedDisplayName: 0,
      		UTExportedTypeDeclarations: [{
      			UTTypeIdentifier: 'jp.kizunacoin.coin',
      			UTTypeDescription: 'Kizunacoin Private Coin',
