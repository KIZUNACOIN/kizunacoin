...
angular.module('copayApp.controllers').controller('recoveryFromSeed',
	function ($rootScope, $scope, $log, $timeout, profileService) {
		...
		var wallet_defined_by_keys = require('core/wallet_defined_by_keys.js');
		var objectHash = require('core/object_hash.js');
		try{
			var ecdsa = require('secp256k1');
		}
		catch(e){
			var ecdsa = require('core/node_modules/secp256k1' + '');
		}
		var Mnemonic = require('bitcore-mnemonic');
		var Bitcore = require('bitcore-lib');
		var db = require('core/db.js');
		var network = require('core/network');
		var myWitnesses = require('core/my_witnesses');
